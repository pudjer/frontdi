import type { ClientRule, Data } from "./CoreApiTypes/ClientRule";
...
function createResolver<KEY, DATA extends Data, T extends object>(rule: ClientRule<KEY, DATA, T>): Resolver<KEY, DATA, T> {
